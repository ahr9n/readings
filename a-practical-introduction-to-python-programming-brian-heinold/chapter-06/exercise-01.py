...
if len(s) <= 2:
    ...
    print('The string with its first and last characters removed is: \'', s[1:len(s) - 1], '\'', sep='')

print('The string in all caps is: \'', s.upper(), '\'', sep='')
print('The string with every \'a\' replaced with an \'e\' is: \'', s.replace('a', 'e'), '\'', sep='')
print('The string with every letter replaced by a space is: \'', len(s) * ' ', '\'', sep='')
